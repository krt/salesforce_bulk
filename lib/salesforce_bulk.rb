...
module SalesforceBulk
  ...
  class Api
    ...
    def initialize(username, password, in_sandbox=false, version=nil)
      @connection = SalesforceBulk::Connection.new(username, password, version || @@SALESFORCE_API_VERSION, in_sandbox)
    end
